  ...
  <div id="main" role="main">
    ...
    <div class="login_w">
      <form class="login_f" name="frmLogin" id="frmLogin" method="post">
        <input class="corner_all" type="text" value="Your Email Address" onFocus="if (this.value == 'Your Email Address') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Your Email Address';}" name="txtUserName" id="txtUserName" />
        <input class="corner_all" type="password" name="txtPassword" id="txtPassword" value="Password" onFocus="if (this.value == 'Password') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Password';}"/>
    ...
    <div class="green_w not_member">
      <div class="green_c"> <a href="create-account.php" class="sf_1">Not a Member?</a> </div>
    </div>
