<?php
	...
	$result=mysql_query("SELECT count(*) AS total FROM email_report where u_id = $_SESSION[uid] order by id DESC LIMIT 30");
	...
	$pager_options = array(
		...
		'delta'      => 4,   // See below
		'nextImg'    => '<img class="imgNext" src="img/nextpage.png">',
		'prevImg'    => '<img class="imgPrev" src="img/prepage.png">',
