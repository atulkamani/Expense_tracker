<?php
	...
	$mailQ = mysql_query("insert into email_report (u_id,full_name,email,mobile,notes,mail_content,deduction,saving_amt,date) Values
	 ($user_id,'$fullName','$email','$mobile','$notes','$mailCont',$deductionText,$savingAmt,'$date')") or die(mysql_error());
	//sent mail
	$to = $email;
	$name= $fullName;
	$phone =$mobile;
...
<body>
  <div id="container">
    ...
    <div id="main" role="main">
        ...
        <div align="center">Your mail has been sent successfully.</div>
