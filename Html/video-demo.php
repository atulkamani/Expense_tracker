<?php
	...
	if(isset($_REQUEST['save']) && $_REQUEST['save'] != ''){
		...
		mysql_query("insert into user (email,password,mobile,approve) values('".$email."','".$pass."',".$mobile.",'N')") or die(mysql_error());
		$id = mysql_insert_id();
	}
?>
<!doctype html>
    ...
    <div id="main" role="main">
        ...
        <div class="login_w">
          <form class="login_f" action="" method="post" name="frmaccount" id="frmaccount">
            ...
            <input class="corner_all" type="password" name="pass" id="pass" value="password" onFocus="if (this.value == 'password') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'password';}"/>
